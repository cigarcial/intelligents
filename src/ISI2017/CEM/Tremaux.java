...
public class Tremaux implements AgentProgram {
	...
	//esta funci�n revisa si est� en una posici�n con varias opciones de movimiento
...
//			System.out.println("PF "  +PF+ " PD "+ PD + " PI " +PI);
	...
	//retorna cuantas veces ha sido visitada la posici�n que se puede alcanzar desde el x y actual
...
//				System.out.println("en division " +x +" "+y);
				//si puede moverse a la izquierda revisa si la posici�n ha sido visitada cero, una 
				...
				if(PF && PD && PI){
					...
					//si solo hay una pared para moverse se dirije ah� y se mueve
					if(!PD){
...
//			System.out.println(" 3 opcion " + tercerOpcion);
			...
			//si tiene m�s de una opci�n de movimiento con 0 visitas escoge al azar
			if (primerOpcion.size() != 0){
				...
				//si tiene m�s de una opci�n de movimiento con 1 visitas escoge al azar
				...
				//si tiene m�s de una opci�n de movimiento con 2 visitas o m�s escoge 
				//la de menos visitas
				//esto hay que revisarlo bien porque tal vez da�a un poco la implementaci�n
				else{
